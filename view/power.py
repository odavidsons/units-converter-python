...
class power(tk.Frame):
    ...
    def __init__(self,master):
        ...
        title = tk.Label(master,text="Power Conversion",font=self.fontLarge)
        title.grid(row=0,columnspan=2,sticky="ew",padx=20,pady=10)
        self.fromUnit = tk.StringVar()
        values = dictionaries.powerDict.power_values
    ...
    def convert(self):
        ...
        try:
            conversion = dictionaries.powerDict.power_conversions[from_unit][to_unit]
