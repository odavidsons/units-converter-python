...
Class for rendering the volume conversion frame
"""
import tkinter as tk
import dictionaries.volumeDict
...
class volume(tk.Frame):
    ...
    def __init__(self,master):
        ...
        title = tk.Label(master,text="Volume Conversion",font=self.fontLarge)
        title.grid(row=0,columnspan=2,sticky="ew",padx=20,pady=10)
        self.fromUnit = tk.StringVar()
        values = dictionaries.volumeDict.power_values
    ...
    def convert(self):
        ...
        try:
            conversion = dictionaries.volumeDict.power_conversions[from_unit][to_unit]
