...
class temperature(tk.Frame):
    ...
    def __init__(self,master):
        ...
        title = tk.Label(master,text="Temperature Conversion",font=self.fontLarge)
        title.grid(row=0,columnspan=2,sticky="ew",padx=20,pady=10)
        self.fromUnit = tk.StringVar()
        values = dictionaries.tempDict.temperature_values
        ...
        convert.grid(row=4,column=0,pady=5,columnspan=2)
    ...
    def convert(self):
        ...
        try:
            conversion = dictionaries.tempDict.temperature_conversions[from_unit][to_unit]
